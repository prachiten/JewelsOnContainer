...
{// Copy of paginatedItemsViewModels.cs because my Catalog.cs will be returning CatalogItems so i need to replicate it here
    public class CatalogItem
    {
     ...
     //  public virtual CatalogType CatalogType { get; set; } // virtual to navigate to catalog type page
        ...
        // public virtual CatalogBrand CatalogBrand { get; set; }// vitual to navigate to catalog Brand page
